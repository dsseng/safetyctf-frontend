export default {
  en: {
    ...
    tasks:
      "In total, SafetyCTF has {count} task | In total, SafetyCTF has {count} tasks",
    users:
      "In total, SafetyCTF has {count} user | In total, SafetyCTF has {count} users",
  ...
  ru: {
    ...
    getStarted: "Поехали!🎉",
    descr:
      "Привет, это соревнование по взлому и информационной безопасности🔒🔓",
    ...
    tasks:
      "В SafetyCTF существует {count} задача | В SafetyCTF существует {count} задач",
    users:
      "В SafetyCTF зарегистрирован {count} пользователь | В SafetyCTF зарегистрировано {count} пользователей",
    beOne: "Участвуй и будь одним из них!😎",
    solve: "Участвуй и решай их!🔓",
    super: "Участвуй и решай эти классные испытания!🔐",
    competition:
      'SafetyCTF --  соревнование  по‍ взлому 💻 и информационной безопасности 🔒🔓. CTF переводится как "Capture The Flag". Чтобы получить флаги (коды, начинающиеся с $ctf), нужно решать задачи (таски) 📜',
